...
char filename[256];
int blockNum; //defined number of 
        ...
        if(n > 0 && strlen(CharBuff) > 0){
            ...
            for(int i = 0; i < n; i++){
                if(CharBuff[i] != '\n'){
                    ...
                    } else if (strcmp(ReadBuffer, "JOY_DOWN")){
                        //
                    } else if (strcmp(ReadBuffer, "JOY_LEFT")){
                        //
                    }else if (strcmp(ReadBuffer, "JOY_UP")){
                        //
                    }else if (strcmp(ReadBuffer, "JOY_RIGHT")){
                        //
                    }else {
                        memset(ReadBuffer, 0, sizeof ReadBuffer); //memset to clear out the buffer
                        readSignal = 0;
