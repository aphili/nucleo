...
char filename[256];
//not dynamic use pointer an malloc to 2D array to solve this problem
char strFile[100][500]; //where we will store the entirety of a file
    ...
    do{
        ...
        switch(MenuStrInput){
            ...
            case '3':
                ...
                // if the filename is the one with all the instructions tell : press JOY_NONE to quit
        ...
        if (fp){
            while (fgets(str, MAXCHAR, fp) != NULL){
                ...
                if(strncmp(str, "\n", 1) == 0){
                    ...
                    strcpy(strFile[lineIndex], str);
                }
                write( serial, str, strlen(str));
                printf("%s", strFile[lineIndex]);
                lineIndex++;
